package com.cajan.commonlib.photocropper;
...
public class CropParams {
    ...
    public static final int DEFAULT_ASPECT = 1;//   0：任意剪裁；1：固定剪裁
    ...
    public CropParams(Context context, Boolean isEnable) {
