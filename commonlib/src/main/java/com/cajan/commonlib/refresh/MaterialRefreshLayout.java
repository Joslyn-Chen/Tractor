...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        textType = t.getInt(R.styleable.MaterialRefreshLayout_progress_refresh_text_visibility, 1);
        progressTextColor = t.getColor(R.styleable.MaterialRefreshLayout_progress_refresh_text_color, Color.BLACK);
