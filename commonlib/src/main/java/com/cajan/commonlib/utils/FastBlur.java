package com.cajan.commonlib.utils;
...
public class FastBlur {
   ...
   * 方法一：
   */
  public static void blur1(Context context, Bitmap bitmap, ImageView view) {
    float scaleFactor = 1;//图片缩放比例
    float radius = 20;//模糊程度

    //TODO  简单模糊可以直接用 Bitmap.Config.RGB_565
   ...
   * 方法二：
   */
  public static void blur2(Bitmap bitmap, ImageView view) {
    int scaleRatio = 10;
    int blurRadius = 8;
    Bitmap scaledBitmap = Bitmap.createScaledBitmap(bitmap, bitmap.getWidth() / scaleRatio,
